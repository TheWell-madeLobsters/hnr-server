...
app.get(SIT_SENSE_ROOT + "/status", passport.authenticate('basic', { session: false }), function(req, res) {
...
app.post(SIT_SENSE_ROOT + "/rcv_dati", passport.authenticate('basic', { session: false }), function(req, res) {
